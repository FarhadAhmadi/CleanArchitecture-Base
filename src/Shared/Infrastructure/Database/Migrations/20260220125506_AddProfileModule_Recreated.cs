...
/// <inheritdoc />
public partial class AddProfileModule_Recreated : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                FavoriteMusicTitle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                FavoriteMusicArtist = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                FavoriteMusicFileId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
