...
public sealed class ScanFileRequest
{
    [FromForm(Name = "file")]
...
internal sealed class ScanFile : IEndpoint, IOrderedEndpoint
{
    public int Order => 3;

    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("files/scan", async (
                [FromForm] ScanFileRequest request,
                ICommandHandler<ScanFileCommand, IResult> handler,
