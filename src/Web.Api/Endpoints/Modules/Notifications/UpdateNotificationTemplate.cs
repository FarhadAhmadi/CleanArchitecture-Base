...
internal sealed class UpdateNotificationTemplateEndpoint : IEndpoint, IOrderedEndpoint
{
    ...
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPut("notifications/templates/{templateId:guid}", async (
            ...
            (await handler.Handle(new UpdateNotificationTemplateCommand(templateId, request), cancellationToken)).Match(static x => x, Web.Api.Infrastructure.CustomResults.Problem))
