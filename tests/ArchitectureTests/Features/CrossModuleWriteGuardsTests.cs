...
public sealed class CrossModuleWriteGuardsTests
{
    ...
    public void NotificationMessages_Should_Be_Written_Only_By_Allowed_Writers()
    {
        ...
        [
            ...
            Path.Combine("Modules", "Notifications", "Infrastructure", "Infrastructure", "Notifications", "NotificationMessageWriter.cs"),
            Path.Combine("Shared", "Infrastructure", "Database", "Seeding", "SampleDataSeeder.cs")
        ];
    ...
    public void LogEvents_Should_Be_Written_Only_By_Allowed_Writers()
    {
        ...
        string[] allowedSuffixes =
        [
            Path.Combine("Modules", "Logging", "Infrastructure", "Infrastructure", "Logging", "ApplicationLogWriter.cs"),
            Path.Combine("Modules", "Logging", "Infrastructure", "Infrastructure", "Logging", "LogIngestionService.cs"),
            Path.Combine("Modules", "Logging", "Infrastructure", "Infrastructure", "Logging", "LogRetryWorker.cs"),
            Path.Combine("Shared", "Infrastructure", "Database", "Seeding", "SampleDataSeeder.cs")
        ];
